...
typedef struct __mavlink_dbgcs_comm_control_t {
 uint8_t pump_OnOFF; /*<  
        1 indicates to power on the pump, 0 to power off the pump
      */
 uint8_t resumemission_OnOFF; /*<  
        1 indicates to resume mission enable, 0 to resume mission disable
      */
...
#define MAVLINK_MSG_ID_DBGCS_COMM_CONTROL_CRC 242
#define MAVLINK_MSG_ID_13000_CRC 242
