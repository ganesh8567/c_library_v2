...
typedef struct __mavlink_dbgcs_motorcan_t {
 float current; /*<  
        Indicates value of the current
      */
 float voltage; /*<  
        Indicates value of the voltage
      */
 float rpm; /*<  
        Motor speed
      */
 uint8_t error_flags; /*<  
        States error if any in motor
      */
 uint8_t temperature; /*< [deg] 
...
static inline uint16_t mavlink_msg_dbgcs_motorcan_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               float current, float voltage, float rpm, uint8_t error_flags, uint8_t temperature)
{
...
{
    return mavlink_msg_dbgcs_motorcan_pack(system_id, component_id, msg, dbgcs_motorcan->current, dbgcs_motorcan->voltage, dbgcs_motorcan->rpm, dbgcs_motorcan->error_flags, dbgcs_motorcan->temperature);
}
...
{
    return mavlink_msg_dbgcs_motorcan_pack_chan(system_id, component_id, chan, msg, dbgcs_motorcan->current, dbgcs_motorcan->voltage, dbgcs_motorcan->rpm, dbgcs_motorcan->error_flags, dbgcs_motorcan->temperature);
}
...
{
    return mavlink_msg_dbgcs_motorcan_pack_status(system_id, component_id, _status, msg,  dbgcs_motorcan->current, dbgcs_motorcan->voltage, dbgcs_motorcan->rpm, dbgcs_motorcan->error_flags, dbgcs_motorcan->temperature);
}
...
static inline void mavlink_msg_dbgcs_motorcan_send(mavlink_channel_t chan, float current, float voltage, float rpm, uint8_t error_flags, uint8_t temperature)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_DBGCS_MOTORCAN_LEN];
    _mav_put_float(buf, 0, current);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_dbgcs_motorcan_send(chan, dbgcs_motorcan->current, dbgcs_motorcan->voltage, dbgcs_motorcan->rpm, dbgcs_motorcan->error_flags, dbgcs_motorcan->temperature);
#else
 ...
 */
static inline void mavlink_msg_dbgcs_motorcan_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float current, float voltage, float rpm, uint8_t error_flags, uint8_t temperature)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
