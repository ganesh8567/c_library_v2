...
typedef struct __mavlink_dbgcs_comm_t {
 uint32_t flight_time; /*< [s] 
        Flight time, gets its value from autopilot
      */
 float flowmeter_val; /*<  
        Indicates value of the flowmeter
      */
 float remaining_payload; /*<  
        Indicates value of the fuel remaining
      */
 uint8_t pu_feeback_val; /*<  
        1 indicates pump is on and spraying, 0 indicates pump is off or faulty
      */
 ...
 * @param remaining_payload  
        Indicates value of the fuel remaining
      
 * @param pu_feeback_val  
        1 indicates pump is on and spraying, 0 indicates pump is off or faulty
...
static inline uint16_t mavlink_msg_dbgcs_comm_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint32_t flight_time, float flowmeter_val, float remaining_payload, uint8_t pu_feeback_val)
{
...
{
    return mavlink_msg_dbgcs_comm_pack(system_id, component_id, msg, dbgcs_comm->flight_time, dbgcs_comm->flowmeter_val, dbgcs_comm->remaining_payload, dbgcs_comm->pu_feeback_val);
}
...
{
    return mavlink_msg_dbgcs_comm_pack_chan(system_id, component_id, chan, msg, dbgcs_comm->flight_time, dbgcs_comm->flowmeter_val, dbgcs_comm->remaining_payload, dbgcs_comm->pu_feeback_val);
}
...
{
    return mavlink_msg_dbgcs_comm_pack_status(system_id, component_id, _status, msg,  dbgcs_comm->flight_time, dbgcs_comm->flowmeter_val, dbgcs_comm->remaining_payload, dbgcs_comm->pu_feeback_val);
}
...
static inline void mavlink_msg_dbgcs_comm_send(mavlink_channel_t chan, uint32_t flight_time, float flowmeter_val, float remaining_payload, uint8_t pu_feeback_val)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_DBGCS_COMM_LEN];
    _mav_put_uint32_t(buf, 0, flight_time);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_dbgcs_comm_send(chan, dbgcs_comm->flight_time, dbgcs_comm->flowmeter_val, dbgcs_comm->remaining_payload, dbgcs_comm->pu_feeback_val);
#else
 ...
 */
static inline void mavlink_msg_dbgcs_comm_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t flight_time, float flowmeter_val, float remaining_payload, uint8_t pu_feeback_val)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
